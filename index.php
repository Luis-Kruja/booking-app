        ...
        <div class="apartments__container">
            ...
            <div class="apartments__cards">
                <div class="apartment__card">
                    ...
                    <p class="apartment__description">Spacious 2-bedroom apartment with a stunning sea view. Fully
                        furnished and perfect for families.</p>
                ...
                <div class="apartment__card">
                    ...
                    <p class="apartment__description">Modern studio apartment steps away from the beach. Ideal for
                        couples or solo travelers.</p>
                    <button class="apartment__button">Book Now</button>
                </div>
                <div class="apartment__card">
                    <img src="assets/ap3.png" alt="Apartment 3" class="apartment__image">
                    <h3 class="apartment__name">Luxury Penthouse</h3>
                    <p class="apartment__description">Top-floor penthouse with panoramic sea views and premium
                        amenities. Perfect for a lavish stay.</p>
                    <button class="apartment__button">Book Now</button>
                </div>
                <div class="apartment__card">
